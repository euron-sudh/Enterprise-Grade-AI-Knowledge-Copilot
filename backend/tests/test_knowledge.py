...
async def test_upload_text_document(client: AsyncClient, auth_headers: dict):
    ...
    response = await client.post("/knowledge/documents", files=files, headers=auth_headers)
...
async def test_get_document_after_upload(client: AsyncClient, auth_headers: dict):
    ...
    upload_resp = await client.post("/knowledge/documents", files=files, headers=auth_headers)
